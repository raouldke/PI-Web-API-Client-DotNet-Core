...
# **ExecuteWithHttpInfo**
> ExecuteWithHttpInfo(Dictionary<string, PIRequest> batch)
...
------------- | ------------- | ------------- | -------------
 **batch** | **Dictionary<string, PIRequest>**| The batch of requests.. | [required]


### Return type

ApiResponse<Dictionary<string, PIResponse>>
